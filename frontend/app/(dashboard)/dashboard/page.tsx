          ...
          {[
            {
              ...
              desc: "Master the fundamentals of modern software.",
              icon: TrendingUp,
            },
            {
              title: "UI/UX Foundations",
              desc: "Understand user-centric design principles.",
              icon: Users,
            },
            {
              title: "Product Strategy & Growth",
              desc: "Conceptualize, launch, and scale digital products.",
              icon: Briefcase,
            },
          ].map((path) => (
            <Card key={path.title}>
      ...
      <div className="grid gap-md sm:grid-cols-3">
        ...
        <Card>
          ...
          >
            ...
            <span className="text-headline-md">/ 5.0</span>
          </p>
        </Card>
      </div>
      ...
      <div className="grid gap-md lg:grid-cols-2">
        ...
        <Card className="overflow-hidden p-0">
          ...
          {stats.data && stats.data.todays_schedule.length > 0 ? (
            ...
            <p className="px-md pb-md text-body-md text-on-surface-variant">
