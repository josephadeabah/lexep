  ...
  return (
    <div className="flex flex-col gap-lg">
      <div>
        ...
        <p className="mt-1 text-body-md text-on-surface-variant">Review and respond to new mentorship requests.</p>
      </div>
      ...
      <Card className="overflow-hidden p-0">
        {requests.isLoading ? (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-label-sm text-on-surface-variant">
                      {r.session_type ?? "Mentorship session"} · Requested {formatDate(r.created_at)}
                    </p>
                    {r.message && <p className="mt-1 text-body-md text-on-surface-variant">&ldquo;{r.message}&rdquo;</p>}
                  </div>
                </div>
          ...
          <p className="p-md text-body-md text-on-surface-variant">No pending requests right now.</p>
        )}
      </Card>
    </div>
  );
